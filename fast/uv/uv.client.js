( () => {
    ...
    ;
    var p = (a, t, r) => (r = a != null ? Ie(Ce(a)) : {},
    je(t || !a || !a.__esModule ? q(r, "default", {
        value: a,
        enumerable: !0
    }) : r, a));
    var c = Ue( (Xe, P) => {
        "use strict";
        var m = typeof Reflect == "object" ? Reflect : null, _ = m && typeof m.apply == "function" ? m.apply : function(t, r, e) {
            return Function.prototype.apply.call(t, r, e)
        }
        , f;
        m && typeof m.ownKeys == "function" ? f = m.ownKeys : Object.getOwnPropertySymbols ? f = function(t) {
        ...
        h.prototype.emit = function(t) {
            ...
            if (typeof u == "function")
                ...
                for (var d = u.length, v = z(u, d), e = 0; e < d; ++e)
                    _(v[e], this, r);
            return !0
        }
        ;
        function G(a, t, r, e) {
            ...
            if (w(r),
            i = a._events,
            i === void 0 ? (i = a._events = Object.create(null),
            a._eventsCount = 0) : (i.newListener !== void 0 && (a.emit("newListener", t, r.listener ? r.listener : r),
            i = a._events),
            o = i[t]),
            o === void 0)
                o = i[t] = r,
                ++a._eventsCount;
            else if (typeof o == "function" ? o = i[t] = e ? [r, o] : [o, r] : e ? o.unshift(r) : o.push(r),
            n = B(a),
        ...
        h.prototype.once = function(t, r) {
            return w(r),
            this.on(t, K(this, t, r)),
            this
        }
        ;
        h.prototype.prependOnceListener = function(t, r) {
            return w(r),
            this.prependListener(t, K(this, t, r)),
            this
        }
        ;
        ...
        h.prototype.removeAllListeners = function(t) {
            ...
            if (e.removeListener === void 0)
                ...
                this._eventsCount = 0) : e[t] !== void 0 && (--this._eventsCount === 0 ? this._events = Object.create(null) : delete e[t]),
                this;
            if (arguments.length === 0) {
                var i = Object.keys(e), o;
        ...
        function X(a, t, r) {
            ...
            if (e === void 0)
                return [];
            var n = e[t];
            return n === void 0 ? [] : typeof n == "function" ? r ? [n.listener || n] : [n] : r ? We(n) : z(n, n.length)
        }
        ...
        h.listenerCount = function(a, t) {
            return typeof a.listenerCount == "function" ? a.listenerCount(t) : Q.call(a, t)
        }
        ;
        ...
        ;
        function z(a, t) {
            for (var r = new Array(t), e = 0; e < t; ++e)
                r[e] = a[e];
            return r
        }
        function Fe(a, t) {
    ...
    var x = class extends Y.default {
        ...
        overrideParseFromString() {
            this.ctx.override(this.domProto, "parseFromString", (t, r, e) => {
                ...
                return this.emit("parseFromString", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.string, o.data.type)
            }
            )
        }
        overrideQuerySelector() {
            this.ctx.override(this.docProto, "querySelector", (t, r, e) => {
                ...
                return this.emit("querySelector", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.selectors)
            }
            )
        }
        overrideDomain() {
            this.ctx.overrideDescriptor(this.docProto, "domain", {
                ...
                set: (t, r, [e]) => {
                    ...
                    return this.emit("setDomain", n),
                    n.intercepted ? n.returnValue : n.target.call(n.that, n.data.value)
                }
            })
        }
        overrideReferrer() {
            ...
            this.ctx.override(this.docProto, "createTreeWalker", (t, r, e) => {
                ...
                let[n,i=4294967295,o,l] = e
                  , u = new s({
                    ...
                    show: i,
                    filter: o,
                    expandEntityReferences: l
                },t,r);
                return this.emit("createTreeWalker", u),
                u.intercepted ? u.returnValue : u.target.call(u.that, u.data.root, u.data.show, u.data.filter, u.data.expandEntityReferences)
            }
            )
        }
        overrideWrite() {
        ...
        overrideDocumentURI() {
            this.ctx.overrideDescriptor(this.docProto, "documentURI", {
                get: (t, r) => {
                    ...
                    return this.emit("documentURI", e),
                    e.intercepted ? e.returnValue : e.data.value
                }
            })
        }
    ...
    var b = class extends $.default {
        ...
        overrideAttribute() {
            this.ctx.override(this.elemProto, "getAttribute", (t, r, e) => {
                ...
                return this.emit("getAttribute", i),
            ...
            this.ctx.override(this.elemProto, "setAttribute", (t, r, e) => {
                ...
                return this.emit("setAttribute", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name, o.data.value)
            }
            ),
            this.ctx.override(this.elemProto, "hasAttribute", (t, r, e) => {
                ...
                return this.emit("hasAttribute", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
            }
            ),
            this.ctx.override(this.elemProto, "removeAttribute", (t, r, e) => {
                ...
                return this.emit("removeAttribute", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
            }
            )
        }
        overrideAudio() {
            this.ctx.override(this.window, "Audio", (t, r, e) => {
                if (!e.length)
                    return new t(...e);
                let[n] = e
                  , i = new s({
        ...
        overrideHtml() {
            this.hookProperty(this.Element, "innerHTML", {
                get: (t, r) => {
                    ...
                    return this.emit("getInnerHTML", e),
                    e.intercepted ? e.returnValue : e.data.value
                }
                ,
                set: (t, r, [e]) => {
            ...
            this.hookProperty(this.Element, "outerHTML", {
                get: (t, r) => {
                    ...
                    return this.emit("getOuterHTML", e),
                    e.intercepted ? e.returnValue : e.data.value
                }
                ,
                set: (t, r, [e]) => {
        ...
        overrideInsertAdjacentHTML() {
            this.ctx.override(this.elemProto, "insertAdjacentHTML", (t, r, e) => {
                ...
                return this.emit("insertAdjacentHTML", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.position, o.data.html)
            }
            )
        }
        overrideInsertAdjacentText() {
            this.ctx.override(this.elemProto, "insertAdjacentText", (t, r, e) => {
                ...
                return this.emit("insertAdjacentText", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.position, o.data.text)
            }
            )
        }
        hookProperty(t, r, e) {
            ...
            if (this.ctx.nativeMethods.isArray(t)) {
                for (let i of t)
                    this.hookProperty(i, r, e);
                return !0
            }
            let n = t.prototype;
            return this.ctx.overrideDescriptor(n, r, e),
            !0
        }
    }
      , ee = b;
    ...
    var L = class extends te.default {
        ...
        overrideTextContent() {
            this.ctx.overrideDescriptor(this.nodeProto, "textContent", {
                get: (t, r) => {
                    ...
                    return this.emit("getTextContent", e),
                    e.intercepted ? e.returnValue : e.data.value
                }
                ,
                set: (t, r, [e]) => {
        ...
        overrideAppend() {
            ...
            this.ctx.override(this.nodeProto, "appendChild", (t, r, e) => {
                ...
                return this.emit("appendChild", i),
        ...
        overrideParent() {
            ...
            this.ctx.overrideDescriptor(this.nodeProto, "parentElement", {
                get: (t, r) => {
                    ...
                    return this.emit("parentElement", e),
                    e.intercepted ? e.returnValue : e.data.node
                }
            })
        }
        overrideOwnerDocument() {
            this.ctx.overrideDescriptor(this.nodeProto, "ownerDocument", {
                get: (t, r) => {
                    ...
                    return this.emit("ownerDocument", e),
                    e.intercepted ? e.returnValue : e.data.document
                }
            })
        }
        overrideCompareDocumentPosit1ion() {
            this.ctx.override(this.nodeProto, "compareDocumentPosition", (t, r, e) => {
                if (!e.length)
                    return t.apply(r, e);
                let[n] = e
                  , i = new s({
                ...
                return i.intercepted ? i.returnValue : i.target.call(i.that, i.data.node)
            }
            )
        }
    ...
    var O = class extends ie.default {
        ...
        overrideItemMethods() {
            this.ctx.override(this.attrProto, "getNamedItem", (t, r, e) => {
                ...
                return this.emit("getNamedItem", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
            }
            ),
            this.ctx.override(this.attrProto, "setNamedItem", (t, r, e) => {
                ...
                return this.emit("setNamedItem", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name, o.data.value)
            }
            ),
            this.ctx.override(this.attrProto, "removeNamedItem", (t, r, e) => {
                ...
                return this.emit("removeNamedItem", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
            }
            ),
            ...
            this.ctx.override(this.attrProto, "getNamedItemNS", (t, r, e) => {
                ...
                return this.emit("getNamedItemNS", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.namespace, o.data.localName)
            }
            ),
            this.ctx.override(this.attrProto, "setNamedItemNS", (t, r, e) => {
                ...
                return this.emit("setNamedItemNS", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
            }
            ),
            this.ctx.override(this.attrProto, "removeNamedItemNS", (t, r, e) => {
                ...
                return this.emit("removeNamedItemNS", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.namespace, o.data.localName)
            }
            )
        }
    ...
    var M = class extends oe.default {
        ...
        overrideFunction() {
            this.ctx.override(this.window, "Function", (t, r, e) => {
                if (!e.length)
                    return t.apply(r, e);
                let n = e[e.length - 1]
                  , i = [];
                ...
                return this.emit("function", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, ...o.data.args, o.data.script)
            }
            , !0)
        }
        overrideToString() {
    ...
    var E = class extends ae.default {
        ...
        overrideGetPropertyNames() {
            this.ctx.override(this.Object, "getOwnPropertyNames", (t, r, e) => {
                ...
                return this.emit("getOwnPropertyNames", i),
                i.intercepted ? i.returnValue : i.data.names
            }
            )
        }
        overrideGetOwnPropertyDescriptors() {
            this.ctx.override(this.Object, "getOwnPropertyDescriptors", (t, r, e) => {
                if (!e.length)
                    return t.apply(r, e);
                let[n] = e
                  , i = new s({
                    descriptors: t.call(r, n)
                },t,r);
                return this.emit("getOwnPropertyDescriptors", i),
    ...
    var S = class extends he.default {
        ...
        overrideRequest() {
            return this.fetch ? (this.ctx.override(this.window, "fetch", (t, r, e) => {
                ...
                return this.emit("request", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.input, o.data.options)
            }
            ),
            this.ctx.override(this.window, "Request", (t, r, e) => {
                if (!e.length)
                    return new t(...e);
                let[n,i={}] = e
                  , o = new s({
                ...
                return this.emit("request", o),
                o.intercepted ? o.returnValue : new o.target(o.data.input,o.data.options)
            }
            , !0),
            !0) : !1
        }
        overrideUrl() {
            ...
            this.ctx.overrideDescriptor(this.resProto, "url", {
                get: (t, r) => {
                    ...
                    return this.emit("responseUrl", e),
                    e.intercepted ? e.returnValue : e.data.value
                }
            }),
            !0
        ...
        overrideHeaders() {
            return this.Headers ? (this.ctx.overrideDescriptor(this.reqProto, "headers", {
                get: (t, r) => {
                    ...
                    return this.emit("requestHeaders", e),
                    e.intercepted ? e.returnValue : e.data.value
                }
            }),
            this.ctx.overrideDescriptor(this.resProto, "headers", {
                get: (t, r) => {
                    ...
                    return this.emit("responseHeaders", e),
                    e.intercepted ? e.returnValue : e.data.value
                }
            }),
            ...
            this.ctx.override(this.headersProto, "append", (t, r, e) => {
                ...
                return this.emit("appendHeader", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name, o.data.value)
            }
            ),
            this.ctx.override(this.headersProto, "delete", (t, r, e) => {
                ...
                return this.emit("deleteHeader", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
            }
            ),
            !0) : !1
    ...
    var D = class extends de.default {
        ...
        overrideOpen() {
            this.ctx.override(this.xhrProto, "open", (t, r, e) => {
                ...
                return this.emit("open", d),
                d.intercepted ? d.returnValue : d.target.call(d.that, d.data.method, d.data.input, d.data.async, d.data.user, d.data.password)
            }
            )
        }
        overrideResponseUrl() {
        ...
        overrideSetReqHeader() {
            this.ctx.override(this.xhrProto, "setRequestHeader", (t, r, e) => {
                ...
                return this.emit("setReqHeader", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name, o.data.value)
            }
            )
        }
        overrideGetResHeaders() {
            this.ctx.override(this.xhrProto, "getAllResponseHeaders", (t, r) => {
                ...
                return this.emit("getAllResponseHeaders", e),
                e.intercepted ? e.returnValue : e.data.value
            }
            )
        }
    ...
    var V = class extends pe.default {
        ...
        overrideConstruct() {
            this.ctx.override(this.window, "EventSource", (t, r, e) => {
                if (!e.length)
                    return new t(...e);
                let[n,i={}] = e
                  , o = new s({
                ...
                return this.emit("construct", o),
                o.intercepted ? o.returnValue : new o.target(o.data.url,o.data.config)
            }
            , !0),
    ...
    var k = class extends me.default {
        ...
        overridePushState() {
            this.ctx.override(this.historyProto, "pushState", (t, r, e) => {
                ...
                return this.emit("pushState", l),
                l.intercepted ? l.returnValue : l.target.call(l.that, l.data.state, l.data.title, l.data.url)
            }
            )
        }
        overrideReplaceState() {
            this.ctx.override(this.historyProto, "replaceState", (t, r, e) => {
                ...
                return this.emit("replaceState", l),
                l.intercepted ? l.returnValue : l.target.call(l.that, l.data.state, l.data.title, l.data.url)
            }
            )
        }
        ...
        emulate(t, r) {
            ...
            for (let i of n.keys)
                this.ctx.nativeMethods.defineProperty(e, i, {
                    ...
                    set: i !== "origin" ? function(o) {
                        switch (i) {
                        case "href":
                            n.location.href = r(o);
                            break;
                        case "hash":
                            n.emit("hashchange", e.href, o.trim().startsWith("#") ? new URL(o.trim(),e.href).href : new URL("#" + o.trim(),e.href).href, n);
                            break;
                        default:
                            {
                                let l = new URL(e.href);
                                l[i] = o,
                                n.location.href = r(l.href)
                            }
                            break
                        }
                    }
            ...
            return "reload"in this.location && this.ctx.nativeMethods.defineProperty(e, "reload", {
                value: this.ctx.wrap(this.location, "reload", (i, o) => i.call(o === e ? this.location : o)),
                writable: !1,
                enumerable: !0
            }),
            "replace"in this.location && this.ctx.nativeMethods.defineProperty(e, "replace", {
                value: this.ctx.wrap(this.location, "assign", (i, o, l) => {
                    (!l.length || o !== e) && i.call(o),
                    o = this.location;
                    let[u] = l
                      , d = new URL(u,e.href);
            ...
            "assign"in this.location && this.ctx.nativeMethods.defineProperty(e, "assign", {
                value: this.ctx.wrap(this.location, "assign", (i, o, l) => {
                    (!l.length || o !== e) && i.call(o),
                    o = this.location;
                    let[u] = l
            ...
            "ancestorOrigins"in this.location && this.ctx.nativeMethods.defineProperty(e, "ancestorOrigins", {
                get() {
                    let i = [];
                    return n.window.DOMStringList && n.ctx.nativeMethods.setPrototypeOf(i, n.window.DOMStringList.prototype),
                    i
                },
                set: void 0,
                enumerable: !0
            ...
            this.ctx.window.Location && this.ctx.nativeMethods.setPrototypeOf(e, this.ctx.window.Location.prototype),
            e
        }
    }
      , N = R;
    ...
    var I = class extends ye.default {
        ...
        overridePostMessage() {
            this.ctx.override(this.window, "postMessage", (t, r, e) => {
                ...
                l.intercepted ? l.returnValue : this.ctx.worker ? l.target.call(l.that, l.data.message, l.data.transfer) : l.target.call(l.that, l.data.message, l.data.origin, l.data.transfer)
            }
            )
        }
        wrapPostMessage(t, r, e=!1) {
            return this.ctx.wrap(t, r, (n, i, o) => {
                ...
                return this.emit("postMessage", v),
                v.intercepted ? v.returnValue : e ? v.target.call(v.that, v.data.message, v.data.transfer) : v.target.call(v.that, v.data.message, v.data.origin, v.data.transfer)
            }
            )
        }
    ...
    var H = class extends ge.default {
        ...
        overrideSendBeacon() {
            this.ctx.override(this.navProto, "sendBeacon", (t, r, e) => {
                ...
                return this.emit("sendBeacon", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.url, o.data.data)
            }
            )
        }
    }
    ...
    var A = class extends be.default {
        ...
        overrideWorker() {
            this.ctx.override(this.window, "Worker", (t, r, e) => {
                if (!e.length)
                    return new t(...e);
                let[n,i={}] = e
                  , o = new s({
                ...
                return this.emit("worker", o),
                o.intercepted ? o.returnValue : new o.target(o.data.url,o.data.options)
            }
            , !0)
        }
        overrideAddModule() {
            this.ctx.override(this.workletProto, "addModule", (t, r, e) => {
                ...
                return this.emit("addModule", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.url, o.data.options)
            }
            )
        }
        overridePostMessage() {
            this.ctx.override(this.workerProto, "postMessage", (t, r, e) => {
                ...
                return this.emit("postMessage", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.message, o.data.transfer)
            }
            )
        }
        overrideImportScripts() {
            this.ctx.override(this.window, "importScripts", (t, r, e) => {
                ...
                return this.emit("importScripts", n),
                n.intercepted ? n.returnValue : n.target.apply(n.that, n.data.scripts)
            }
            )
        }
    }
    ...
    var C = class extends Oe.default {
        ...
        overrideObjectURL() {
            this.ctx.override(this.URL, "createObjectURL", (t, r, e) => {
                ...
                return this.emit("createObjectURL", i),
            ...
            this.ctx.override(this.URL, "revokeObjectURL", (t, r, e) => {
                ...
                return this.emit("revokeObjectURL", i),
    ...
    var T = class extends Ee.default {
        ...
        overrideMethods() {
            this.ctx.override(this.storeProto, "getItem", (t, r, e) => {
                if (!e.length)
                    return t.apply(this.wrappers.get(r) || r, e);
                let[n] = e
                  , i = new s({
                    name: n
                },t,this.wrappers.get(r) || r);
                return this.emit("getItem", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.name)
            }
            ),
            ...
            this.ctx.override(this.storeProto, "key", (t, r, e) => {
                ...
                return this.emit("key", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.index)
            }
            )
        }
        overrideLength() {
    ...
    var U = class extends De.default {
        constructor(t) {
            ...
            this.cssText - t.nativeMethods.getOwnPropertyDescriptors(this.cssStyleProto, "cssText"),
        ...
        overrideSetGetProperty() {
            this.ctx.override(this.cssStyleProto, "getPropertyValue", (t, r, e) => {
                ...
                return this.emit("getPropertyValue", i),
                i.intercepted ? i.returnValue : i.target.call(i.that, i.data.property)
            }
            ),
            this.ctx.override(this.cssStyleProto, "setProperty", (t, r, e) => {
                ...
                return this.emit("setProperty", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.property, o.data.value)
            }
            )
        }
        overrideCssText() {
    ...
    var j = class extends ke.default {
        ...
        overrideOpen() {
            this.ctx.override(this.IDBFactory.prototype, "open", (t, r, e) => {
                ...
                return this.emit("idbFactoryOpen", o),
                o.intercepted ? o.returnValue : o.target.call(o.that, o.data.name, o.data.version)
            }
            )
        }
        overrideName() {
            this.ctx.overrideDescriptor(this.idbDatabaseProto, "name", {
                get: (t, r) => {
                    ...
                    return this.emit("idbFactoryName", e),
                    e.intercepted ? e.returnValue : e.data.value
                }
            })
        }
    ...
    var y = class extends Ne.default {
        ...
        overrideDescriptor(t, r, e={}) {
            ...
            return n ? (this.nativeMethods.defineProperty(t, r, n),
            n) : {}
        }
        wrap(t, r, e, n) {
            let i = t[r];
            ...
            return n && (o.prototype = i.prototype,
        ...
        wrapDescriptor(t, r, e={}) {
            ...
            if (!n)
                return !1;
            for (let i in e)
                i in n && (i === "get" || i === "set" ? n[i] = this.wrap(n, i, e[i]) : n[i] = typeof e[i] == "function" ? e[i](n[i]) : e[i]);
            return n
        }
    }
      , Qt = y;
